 ...
 * step (the migration plan's step 6) that needs the account owner to
 * confirm test credentials are actually configured first; this foundation
 * phase only proves the interface and bookkeeping are correct.
 */
