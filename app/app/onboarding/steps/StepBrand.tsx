  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <FormField label="Tone / personality" htmlFor={toneId} optional hint="e.g. Direct, warm, consultative">
          <Input
            id={toneId}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <FormField label="Target audience" htmlFor={audienceId} optional>
          <Input
            id={audienceId}
        ...
        >
          <Input id={descId} value={draft.brand.description} onChange={(e) => update({ description: e.target.value })} placeholder="Brief summary of your business" className="h-11" />
        </FormField>
      </div>
