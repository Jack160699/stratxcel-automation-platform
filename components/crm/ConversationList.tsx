...
export function ConversationList({
  ...
  return (
    <div className="flex h-full flex-col border-r border-sx-border bg-sx-surface-1">
      <div className="flex shrink-0 flex-col gap-2.5 border-b border-sx-border px-3 py-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-8 w-full rounded-sx-sm border border-sx-border-strong bg-sx-surface-2 pl-8 pr-2.5 text-[12.5px] text-sx-text placeholder:text-sx-text-subtle outline-none focus-visible:border-sx-accent"
          />
        </div>
