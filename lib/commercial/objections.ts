...
export const JOURNEY_OBJECTIONS: ObjectionFaq[] = [
  ...
  { id: "start_small", question: "Can I start small?", answer: "Yes — free explore, ₹999 audit roadmap, or Starter when ready." },
...
export const PRICING_OBJECTIONS: ObjectionFaq[] = [
  { id: "audit_flow", question: "How does the Business Growth Audit work?", answer: "Pay ₹999 once, complete intake, receive a staff-delivered 30/60/90-day roadmap." },
  ...
  { id: "audit_subscription", question: "Does the audit start a subscription?", answer: "No. One-time purchase only; monthly plans confirmed separately." },
];
