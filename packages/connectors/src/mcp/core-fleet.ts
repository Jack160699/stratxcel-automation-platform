...
export const CORE_SIX_FLEET: Record<CoreProviderDomain, CoreFleetProviderSpec> = {
  ...
  Supabase: {
    ...
    capabilities: [
      ...
      {
        capabilityKey: "lead.discover",
        name: "Universal Multi-Source Lead Discovery",
        description: "Provider-neutral autonomous lead acquisition across grounded catalogs, maps, directories, and search",
        riskLevel: "low",
        confirmationPolicy: "autonomous",
        requiredPermissions: ["leads:write", "leads:read"],
        isHighConsequence: false,
      ...
      {
        capabilityKey: "lead.enrich",
        name: "Autonomous Lead Enrichment & Intelligence",
        description: "Enrich business entities via official website crawling, structured metadata, and B2B sources",
        riskLevel: "low",
        confirmationPolicy: "autonomous",
        requiredPermissions: ["leads:write"],
        isHighConsequence: false,
      ...
      {
        capabilityKey: "lead.verify",
        name: "Lead & Domain Verification",
        description: "Verify authenticity of company websites, phone numbers, and operational signals",
        riskLevel: "read_only",
        confirmationPolicy: "autonomous",
      ...
      {
        capabilityKey: "lead.deduplicate",
        name: "Deterministic Identity Resolution & Deduplication",
        description: "Resolve multi-source sightings into single canonical entities via SHA-256 identity hashing",
        riskLevel: "read_only",
        confirmationPolicy: "autonomous",
        requiredPermissions: ["leads:read"],
        isHighConsequence: false,
      ...
      {
        capabilityKey: "lead.qualify",
        name: "Explainable Lead Qualification Scoring",
        description: "Calculate 0-100 deterministic qualification score across geography, industry, and contactability",
        riskLevel: "read_only",
        confirmationPolicy: "autonomous",
        requiredPermissions: ["leads:read"],
        isHighConsequence: false,
      ...
      {
        capabilityKey: "lead.search_more_sources",
        name: "Adaptive Source Search Depth",
        description: "Query additional discovery sources when initial sources yield insufficient qualified prospects",
        riskLevel: "low",
        confirmationPolicy: "autonomous",
        requiredPermissions: ["leads:write"],
        isHighConsequence: false,
      ...
      {
        capabilityKey: "lead.get_provenance",
        name: "Retrieve Lead Provenance History",
        description: "Inspect multi-source discovery lineage, verification methods, and evidence trail",
        riskLevel: "read_only",
        confirmationPolicy: "autonomous",
        requiredPermissions: ["leads:read"],
        isHighConsequence: false,
