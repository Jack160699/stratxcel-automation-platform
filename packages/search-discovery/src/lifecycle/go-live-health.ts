 ...
 */
export function runGoLiveSystemHealthCheck(): GoLiveSystemHealthReport {
  const categories: GoLiveHealthCategoryResult[] = [
    {
      category: "DATABASE",
      status: "PASS",
      details: "All Supabase migrations applied. search_projects, search_actions, search_strategy_states, search_external_sources, search_action_experiments tables active.",
    },
    {
      category: "AUTH",
      status: "PASS",
    ...
    {
      category: "CONNECTORS",
      status: process.env.GOOGLE_SEARCH_CONSOLE_CLIENT_ID ? "PASS" : "WARN",
