...
export const CONNECTOR_REGISTRY: readonly ConnectorDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Unified Google Workspace, Cloud, and Founder Services (Gemini, AI Studio, Drive, Cloud Console, Colab, Jules, Search, Maps). Authenticates via Founder Browser session, OAuth 2.0, or API.",
    realStatusSource: "Google authenticated Founder Browser session and API health checks",
    requiredEnvVars: [],
    supportedAccessMethods: ["native", "api", "browser"],
  ...
  },
  {
    ...
    declaredCapabilities: [
      ...
      // Google authenticated browser workflows
      "gemini.chat",
      "aistudio.prompt",
      "drive.browse",
      "drive.download",
  ...
  },
  {
    ...
    description:
      "Meta Business Cloud API messaging surface (WhatsApp Cloud) and social publishing (Facebook Pages, Instagram Business, Threads). Reads real social_accounts and phone_bindings.",
    realStatusSource: "social_accounts and phone_bindings status, read-only adapter and Graph API check",
    requiredEnvVars: [],
    supportedAccessMethods: ["api", "browser"],
    preferredAccessMethod: "api",
  },
  {
    key: "whatsapp",
