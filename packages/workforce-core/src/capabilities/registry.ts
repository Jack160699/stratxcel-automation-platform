...
export const CAPABILITY_REGISTRY: Record<CapabilityKey, CapabilityDefinition> = {
  ...
  "content.shortform": cap("content.shortform", {
    ...
    integrationRequirements: [],
    tenantScoped: true,
    implementationPath: "lib/social/agent + Hermes create_draft_artifact",
  }),
  ...
  "social.schedule": cap("social.schedule", {
    ...
    tenantScoped: true,
    implementationPath: "lib/social/package-autopilot + publishing queue",
  }),
  "social.publish": cap("social.publish", {
    ...
    integrationRequirements: ["social_account"],
    tenantScoped: true,
    implementationPath: "lib/social/worker.ts + provider adapters",
  }),
  "seo.audit": cap("seo.audit", {
    ...
    integrationRequirements: [],
    tenantScoped: true,
    implementationPath: "packages/search-discovery + /app/search",
  }),
  ...
  "website.generate": cap("website.generate", {
    ...
    integrationRequirements: [],
    tenantScoped: true,
    implementationPath: "packages/websites-and-domains (draft/generate path)",
  }),
  ...
  "website.audit": cap("website.audit", {
    ...
    providerKeys: ["website-audit-placeholder"],
    integrationRequirements: [],
    tenantScoped: true,
    implementationPath: "packages/workforce-core/src/capabilities (contract only)",
  }),
  ...
  "crm.read": cap("crm.read", {
    ...
    integrationRequirements: [],
    tenantScoped: true,
    implementationPath: "packages/leads-and-crm/src/repository.ts",
  }),
