...
export const metadata: Metadata = {
  title: "AI Marketing Agent — Campaigns, Ad Planning & Attribution | Stratxcel",
  description:
    "Stratxcel AI Marketing Agent plans multi-channel campaign architectures, drafts ad creative variants, and evaluates spend efficiency with full budget governance.",
  alternates: {
    canonical: "https://www.stratxcel.in/ai-marketing-agent",
  },
  openGraph: {
    title: "AI Marketing Agent — Stratxcel",
    description: "Governed campaign planning, ad creative testing, and return intelligence.",
    url: "https://www.stratxcel.in/ai-marketing-agent",
    siteName: "Stratxcel",
    images: [{ url: "/logo-v2.png", width: 641, height: 641, alt: "Stratxcel AI Marketing Agent" }],
    type: "article",
  },
};
    ...
    <PublicPageShell>
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <p className="font-sx-mono text-[11px] font-semibold uppercase tracking-[0.24em] text-sx-accent">
          SPECIALIST AGENT · CAMPAIGNS & GROWTH
        </p>
        <h1 className="mt-4 max-w-3xl font-sx-sans text-[clamp(2.2rem,4.5vw+0.3rem,3.4rem)] font-bold leading-tight tracking-tight text-sx-text">
          AI Marketing Agent with built-in budget and creative governance.
        </h1>
        <p className="mt-6 max-w-2xl font-sx-sans text-[16px] leading-relaxed text-sx-text-muted sm:text-[18px]">
          Coordinate multi-channel campaigns, visual creative variations, and ad copy tests. Every spend allocation and
          live campaign requires explicit human authorization.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3.5">
          <TrackedCtaLink
            ...
            surface="ai_marketing_agent_hero"
            plan="audit"
      ...
      <section className="border-t border-sx-border bg-sx-surface-1 py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <h2 className="font-sx-sans text-2xl font-bold tracking-tight text-sx-text sm:text-3xl">
            Governed Marketing Capabilities
          </h2>
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-sx-border bg-sx-bg p-6">
              <h3 className="font-sx-sans text-base font-bold text-sx-text">Campaign Planning & Mix</h3>
              <p className="mt-2 font-sx-sans text-sm leading-relaxed text-sx-text-muted">
                Designs cross-channel media plans tailored to your audience segments and target CAC goals.
              </p>
            </div>
            <div className="rounded-xl border border-sx-border bg-sx-bg p-6">
              <h3 className="font-sx-sans text-base font-bold text-sx-text">Creative Studio Integration</h3>
              <p className="mt-2 font-sx-sans text-sm leading-relaxed text-sx-text-muted">
                Generates still and carousel visual variations aligned with Brand Brain aesthetic guidelines.
              </p>
            </div>
            <div className="rounded-xl border border-sx-border bg-sx-bg p-6">
              <h3 className="font-sx-sans text-base font-bold text-sx-text">Spend Governance</h3>
              <p className="mt-2 font-sx-sans text-sm leading-relaxed text-sx-text-muted">
                Ad campaigns and budget adjustments are strictly gated behind human approval rules before activation.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <div className="mt-8 flex justify-center">
            <TrackedCtaLink
              href="/audit"
              event="start_audit"
              surface="ai_marketing_agent_footer"
              plan="audit"
