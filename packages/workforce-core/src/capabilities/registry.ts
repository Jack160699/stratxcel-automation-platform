...
export const CAPABILITY_REGISTRY: Record<CapabilityKey, CapabilityDefinition> = {
  "research.web": cap("research.web", {
    ...
    providerKeys: ["research-grounded-web"],
    integrationRequirements: [],
    tenantScoped: true,
    implementationPath:
      "packages/workforce-core/src/adapters/research-web.ts → @stratxcel/search-discovery grounded research engine → @stratxcel/ai-runtime",
  ...
  "research.serp": cap("research.serp", {
    ...
    providerKeys: ["research-serp-search-console"],
    integrationRequirements: ["search_console"],
    tenantScoped: true,
    implementationPath:
      "Owned-property Google Search Console evidence only; tenant production binding is not configured and public SERP scraping is not supported",
  }),
  ...
  "media.image_generation": cap("media.image_generation", {
    ...
    providerKeys: ["media-image-ai-runtime"],
    integrationRequirements: [],
    tenantScoped: true,
    implementationPath: "packages/ai-runtime media + canonical image generation records",
  }),
