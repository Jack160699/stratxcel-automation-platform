          ...
          <div className="mt-10 border-t border-sx-border pt-8" id="architecture">
            ...
            <div className="mt-10 max-w-3xl">
              ...
              <p className="mt-3 font-sx-sans text-[14.5px] leading-relaxed text-sx-text-muted">
                ...
                work to the right <strong className="font-semibold text-sx-text">modules</strong>. Execution writes back
                to your systems of record; observability closes the loop with SLOs, replay, and escalation paths.
              </p>
