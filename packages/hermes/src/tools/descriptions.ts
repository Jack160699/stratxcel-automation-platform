...
export const TOOL_DESCRIPTIONS: Record<ToolName, string> = {
  ...
  browser_navigate: "Navigate the Founder Computer browser environment to a designated URL. Input: { url, sessionKey? }.",
  browser_screenshot: "Capture a screenshot of the current page in the Founder Computer browser environment. Input: { sessionKey? }.",
  browser_read: "Extract text and structured DOM content from the active page in the Founder Computer browser environment. Input: { selector?, sessionKey? }.",
};
