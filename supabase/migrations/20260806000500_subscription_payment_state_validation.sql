-- Additive migration: Subscription payment state validation for reconcile_and_fulfill_razorpay_payment_v4
-- Restricts subscription payments to payment-eligible states ('pending_payment', 'payment_failed', 'past_due').
-- Rejects active, cancelled, refunded, expired, paused subscriptions with reason = 'subscription_state_not_payable'.
...
begin
  ...
  -- ============================================================
  -- 5. PRE-MUTATION VALIDATIONS (Product resolution, Plan Tier & Subscription State Check)
